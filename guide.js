...
const DOCS = [
  ...
  { chapter: 'Apps', pages: [
    ...
    { id: 'apps', title: 'The apps', icon: 'grid',
      ...
      { id: 'connect', h: 'Connect', body: () => `
        <p><b>Private rooms</b> for calls, screen sharing and chat. Make a room and you get a <b>5-character code</b> (letters and numbers, like <code>ABC23</code>) — that code is the only way in. Rooms are never listed to anyone who hasn't joined, so sharing the code <i>is</i> how you invite someone. Tap the code anywhere to copy it.</p>
        <p>In a room you can turn on your <b>microphone</b>, your <b>camera</b>, and <b>share your screen</b> — any combination, toggled from the bar at the bottom. <b>Click anyone's tile to focus them</b>: they fill the stage while everyone else shrinks to a strip along the bottom, so you never lose track of the room. Click again to go back to the grid. Raise a hand when you don't want to interrupt.</p>
        <p><b>A screen share is its own tile</b>, not a replacement for the sharer's camera — so you can see someone's face and their screen at the same time. Other people's shares start as a still <b>preview</b> (about a frame a second, no sound) until you <b>open</b> them, which keeps a busy room from bogging your machine down. Click a preview to open it, and <b>right-click a stream to close it</b> again (or focus it and choose <i>Close stream</i>).</p>
        <p>On a computer, <b>right-click someone</b> for controls that are yours alone: set their <b>volume</b>, <b>mute them just for you</b>, or <b>ignore</b> them entirely (hiding their camera, microphone and screen). Nobody is told — these only change what <i>you</i> see and hear, and anyone you've hidden can be brought back from the <b>hidden</b> chip in the control bar. The <b>chat</b> runs alongside the call: <b>right-click a message</b> to react, reply, copy, edit or delete it.</p>
        <p><b>The call is end-to-end encrypted.</b> Audio and video travel <i>directly between the people in the room</i> — Simplex passes only the initial handshake and never holds a key that could decrypt a single frame of your screen, camera or voice. Audio is sent as 64 kbps stereo. Because everyone connects to everyone, a room holds up to <b>8 people</b> at once.</p>
        <p><b>Rooms are temporary by default.</b> Once everyone has left the call, the room and its chat are deleted automatically — so a quick catch-up doesn't leave clutter behind. If you want a room to stick around, the owner can tick <b>Keep this room permanently</b> in room settings. There's a short grace period, so refreshing the page or dropping off Wi-Fi for a moment won't destroy the room.</p>
        <p>You can <b>share files into the chat</b> two ways. <b>From this device</b> uploads straight from your phone or computer — those files live only in the room, so <b>they're deleted from the server when the room is deleted</b>. <b>From my Database</b> copies a file out of your vault, which means your original always stays safe where it is and only the copy goes with the room. Images, video and audio play inline, and small text and markdown files show a <b>preview of their first few lines</b>; anything else appears as a download.</p>
        <p><b>Click a picture or a text file to open it full size.</b> Markdown is rendered properly rather than shown as raw text, and from there you can <b>download</b> it — or, on an iPhone or a Mac, <b>Save to Photos</b> to put an image straight into your camera roll.</p>
        <p><b>Noise cancellation is on by default</b>, and it's yours to adjust. Your browser's own filter handles steady background noise, and on top of that Simplex can <b>mute your microphone between sentences</b> so typing, fans and other people talking don't carry. If it clips the start of your words, or lets too much through, the <b>Noise</b> button opens the controls — <i>sensitivity</i>, <i>how long the mic stays open after you stop</i>, and <i>low-rumble removal</i>. <b>Hear myself</b> plays your own processed microphone back to you (use headphones) with a live meter, so you can tune it by ear instead of guessing.</p>
        <p>Video quality is yours to pick. In <b>Devices &amp; quality</b> you can set the <b>camera</b> and the <b>screen share</b> separately — Auto, or a fixed tier from 360p up to 4K60 — which is handy on a data plan or a laptop that gets loud encoding 1080p. If your camera can't produce the exact size you asked for, Simplex quietly settles on the closest mode it does have and tells you which, rather than leaving the camera off. Your voice is always sent as 64 kbps stereo, whatever you choose here.</p>
        <p>The room owner can rename the room, <b>lock</b> it (so the code stops letting new people in), remove people, and delete it. <b>Deleting a room erases its entire chat, every reaction and every shared file with it</b>, for everyone — that's by design, and it can't be undone.</p>` },
