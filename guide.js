...
const DOCS = [
  ...
  { chapter: 'Apps', pages: [
    ...
    { id: 'apps', title: 'The apps', icon: 'grid',
      ...
      { id: 'neural', h: 'Neural Network', body: () => `
        <p>Build, train, and watch <b>your own neural networks</b> — a visual graph/physics sandbox plus a small text model you can train on your own writing. Everything runs in your browser by default; admins can enable server-side training per account. Networks save into your encrypted vault like any other data.</p>` },
