  ...
  { chapter: 'Apps', pages: [
    ...
    { id: 'apps', title: 'The apps', icon: 'grid',
      ...
      { id: 'connect', h: 'Connect', body: () => `
        ...
        <p>In a room you can turn on your <b>microphone</b>, your <b>camera</b>, and <b>share your screen</b> — any combination, toggled from the bar at the bottom. Double-click someone's tile to blow it up to speaker view, and raise a hand when you don't want to interrupt. The <b>chat</b> runs alongside the call: reply to a specific message, add <b>emoji reactions</b>, and edit or delete your own messages.</p>
        ...
        <p>The room owner can rename the room, <b>lock</b> it (so the code stops letting new people in), remove people, and delete it. <b>Deleting a room erases its entire chat and every reaction with it</b>, for everyone — that's by design, and it can't be undone.</p>` },
